    ...
    <div className="container mx-auto px-4 py-12 md:py-20">
      <Card className="max-w-4xl mx-auto">
        ...
        <CardContent className="prose max-w-none">
            <p>For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean JUPITER BANIA, whose registered/operational office is Ledo Kalpara Tinsukia ASSAM 786182 . "you", “your”, "user", “visitor” shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.</p>
            ...
            <ul>
                ...
                <li>You may not create a link to our website from another website or document without JUPITER BANIA’s prior written consent.</li>
