  ...
  return (
    <div className="container mx-auto px-4 py-12 md:py-20">
      <Card className="max-w-4xl mx-auto">
        <CardHeader>
          <CardTitle className="font-headline text-3xl">Cancellations and Refund Policy</CardTitle>
        </CardHeader>
        <CardContent className="prose max-w-none">
            <p>JUPITER BANIA believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:</p>
            <ul>
                ...
                <li>JUPITER BANIA does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.</li>
                ...
                <li>In case of any Refunds approved by the JUPITER BANIA, it’ll take 3-5 days for the refund to be processed to the end customer.</li>
            </ul>
        </CardContent>
      </Card>
    </div>
